...
const SelectTrigger = React.forwardRef(({ className, hasError, children, ...props }, forwardedRef) => {
  return (
...
const SelectScrollUpButton = React.forwardRef(({ className, ...props }, forwardedRef) => (
...
const SelectScrollDownButton = React.forwardRef(({ className, ...props }, forwardedRef) => (
...
const SelectGroupLabel = React.forwardRef(({ className, ...props }, forwardedRef) => (
...
const SelectItem = React.forwardRef(({ className, children, ...props }, forwardedRef) => {
  return (
...
const SelectSeparator = React.forwardRef(({ className, ...props }, forwardedRef) => (
