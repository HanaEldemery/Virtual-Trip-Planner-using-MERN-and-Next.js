  ...
  (
    ...
    return (
      <button
        ...
        disabled={disabled}
        className={cn(
          "flex size-8 outlineNone shrink-0 select-none items-center justify-center rounded border p-1 outline-none transition sm:size-[30px]",
          // text color
        ...
        {...props}
      >
        <Icon className="size-full outlineNone shrink-0" />
      </button>
    )
  },
)
    ...
    <DayPicker
      ...
      classNames={{
        ...
        cell: cn(
          ...
          "text-gray-900 dark:text-gray-50 outlineNone",
        ),
        day: cn(
        ...
        day_outside: "text-gray-400 dark:text-gray-600 outlineNone",
        day_range_middle: cn(
